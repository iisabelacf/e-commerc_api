...
#criação de rotas de login e logout
...
def delete_product(product_id):
    ...
    if product:
        ...
        db.session.commit()
        return jsonify({"message": "Product delete sucessfully"})
...
def remove_from_cart(product_id):
    ...
    return jsonify({'message': 'Failed to removed item from the cart'}), 400
